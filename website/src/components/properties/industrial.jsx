...
const getPropertyTypeIcon = (type) => {
  ...
  return icons[type?.toLowerCase()] || <Factory className="w-4 h-4" />;
};
  ...
  return (
    ...
    >
      ...
      <div className={`p-6 ${isGrid ? "" : "flex-1"}`}>
        ...
        {/* Stats grid - sqft, Industrial, Loading */}
        ...
        {/* Amenities skeleton - Parking, Workshop, 24/7 Security */}
        ...
        >
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 flex gap-2">
              <div className="bg-[#0A1628]/80 backdrop-blur-sm px-3 py-1.5 rounded-lg text-white text-sm flex items-center gap-1.5 border border-white/10">
                ...
                <span>{property.property_type || "Industrial"}</span>
              </div>
          ...
          <div className={`p-6 ${viewMode === "list" ? "flex-1" : ""}`}>
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              <div className="flex items-center justify-center bg-white/5 border border-white/10 rounded-xl py-2.5">
                ...
                <span className="font-semibold text-white text-xs">
                  {property.sqft || property.area_measurement || 0} sqft
                </span>
              </div>
              <div className="flex items-center justify-center bg-white/5 border border-white/10 rounded-xl py-2.5">
                <Warehouse className="w-4 h-4 mr-1.5 text-[#C9A962]" />
                <span className="font-semibold text-white text-xs">Industrial</span>
              </div>
              <div className="flex items-center justify-center bg-white/5 border border-white/10 rounded-xl py-2.5">
                <Truck className="w-4 h-4 mr-1.5 text-[#C9A962]" />
                <span className="font-semibold text-white text-xs">Loading</span>
              </div>
            </div>
            ...
            <div className="flex gap-2 mb-4 flex-wrap">
              ...
              <div className="flex items-center text-xs text-gray-400 bg-white/5 border border-white/10 px-2.5 py-1.5 rounded-lg">
                <Wrench className="w-3 h-3 mr-1 text-[#C9A962]" /> Workshop
              </div>
              <div className="flex items-center text-xs text-gray-400 bg-white/5 border border-white/10 px-2.5 py-1.5 rounded-lg">
                <SiFsecure className="w-3 h-3 mr-1 text-[#C9A962]" /> 24/7 Security
              </div>
            </div>
  ...
  const handleShare = useCallback(
    async (property) => {
      const shareData = {
        ...
        text: `Check out this industrial property: ${property.title} - ${property.location}`,
      ...
      <div className="min-h-screen bg-[#060D16] flex items-center justify-center">
        ...
        >
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={() => dispatch(fetchProperties({ page: 1, page_size: 9999, category: "industrial" }))}
    ...
    <div className="min-h-screen bg-[#060D16]">
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <Factory className="w-4 h-4 text-[#C9A962]" />
            <span className="text-[#C9A962] text-sm font-medium">Industrial Properties</span>
          </motion.div>
          ...
          >
            Discover premium industrial properties including warehouses, factories,
            and manufacturing facilities. Find the perfect space for your operations.
          </motion.p>
            ...
            <div className="flex flex-col lg:flex-row gap-4 items-center mb-4">
              <div className="flex-1 w-full relative">
                <input
                  ...
                  placeholder="Search warehouses, factories, industrial parks..."
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                    ...
                    >
                      ...
                      <option value="100000-500000" className="bg-[#0A1628]">$100K - $500K</option>
                      <option value="500000-1000000" className="bg-[#0A1628]">$500K - $1M</option>
                      <option value="1000000-5000000" className="bg-[#0A1628]">$1M - $5M</option>
                      <option value="5000000-99999999" className="bg-[#0A1628]">$5M+</option>
                    </select>
                    ...
                    >
                      ...
                      <option value="0-5000" className="bg-[#0A1628]">Under 5K sq ft</option>
                      <option value="5000-10000" className="bg-[#0A1628]">5K - 10K sq ft</option>
                      <option value="10000-25000" className="bg-[#0A1628]">10K - 25K sq ft</option>
                      <option value="25000-50000" className="bg-[#0A1628]">25K - 50K sq ft</option>
                      <option value="50000-999999" className="bg-[#0A1628]">50K+ sq ft</option>
                    </select>
                    ...
                    >
                      ...
                      <option value="factory" className="bg-[#0A1628]">Factory</option>
                      <option value="workshop" className="bg-[#0A1628]">Workshop</option>
                      <option value="industrial" className="bg-[#0A1628]">Industrial Park</option>
                    </select>
                  </div>
          ...
          {paginatedProperties.length === 0 ? (
            ...
            >
              <div className="w-20 h-20 bg-[#C9A962]/10 border border-[#C9A962]/20 rounded-full flex items-center justify-center mx-auto mb-6">
                <Factory className="w-10 h-10 text-[#C9A962]" />
              </div>
