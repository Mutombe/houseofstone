...
const LoginPage = () => {
  ...
  const stats = [
    { icon: Building2, label: "2,400+ Properties" },
    { icon: SiFsecure, label: "98% Satisfaction" },
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#0A1628] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-lg">
            ...
            >
              Access your saved properties, manage your listings, and continue
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#060D16]">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-white/20 bg-white/5 text-[#C9A962] focus:ring-[#C9A962] focus:ring-offset-0"
                />
          ...
          <p className="mt-8 text-center text-gray-500 text-sm">
            ...
            <Link to="/terms" className="text-[#C9A962] hover:underline">
              Terms of Service
            </Link>{" "}
            and{" "}
            <Link to="/privacy" className="text-[#C9A962] hover:underline">
              Privacy Policy
            </Link>
          </p>
        </motion.div>
